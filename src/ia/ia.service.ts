...
7. Réponds UNIQUEMENT par la phrase adaptée, sans commentaire`;
  ...
  private getContextePays(country_code: string, langue: string): string {
    const contextes: Record<string, Record<string, string>> = {
      ...
      GH: { en: 'You work for Ghana. Job market: oil & gas, cocoa, gold mining, fintech, construction, agriculture. Key employers: MTN Ghana, Vodafone Ghana, GCB Bank, Ecobank Ghana, Cocobod, AngloGold Ashanti. Regions: Accra, Kumasi, Tamale, Takoradi, Cape Coast. Currency: GHS. USSD: *438#. Certifications: NVTI, COTVET. Ministry: Ministry of Employment & Labour Relations. Funding: COTVET. Institutions: NVTI Accra, Accra Technical University, TVET Kumasi, Takoradi TVET.' },
